...
class NoPastOrder extends StatefulWidget {
  NoPastOrder({Key? key}) : super(key: key);

  @override
  _NoPastOrderState createState() => _NoPastOrderState();
}

class _NoPastOrderState extends State<NoPastOrder> {
  @override
